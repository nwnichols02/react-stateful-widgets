...
and the ideatu of the currently fred programmer on the other. That's two slices of state!
...
export default function Programmers() {
  ...
  const getNameOfFeatured = () => {
    ...
    // programmerList.filter(())

      const foundDev = programmerList.find(dev => dev.id === programmer);
